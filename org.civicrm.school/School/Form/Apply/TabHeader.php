 ...
 */
class School_Form_Apply_TabHeader {
    ...
    static function process( &$form ) {        
        ...
        $tabs = array(
                      ...
                      'Children'         => array( 'title' => ts( 'Other children in the family' ),
                                                   'link'   => null,
                                                   'valid' => false,
                                                   'active' => false,
                                                   'current' => false,
        ...
        foreach ( $tabs as $key => $value ) {
            $tabs[$key]['link'] = CRM_Utils_System::url( 'civicrm/school/apply/' . strtolower($key),
                                                         "{$reset}snippet=4&cid={$applicantId}&pid={$parentId}{$qfKey}" );
            $tabs[$key]['active'] = ($applicantId || $key == 'Applicant') ? true : false;
            $tabs[$key]['valid']  = true;
        }
