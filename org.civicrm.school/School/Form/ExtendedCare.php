...
class School_Form_ExtendedCare extends CRM_Core_Form
{
    ...
    public  function preProcess( ) 
    {
     ...
     public function buildQuickForm( ) 
     {
         ...
         if( $this->_action & CRM_Core_Action::DELETE ) {
             ...
             $buttonLabel = ts('Save'); 
             $students    =  School_Utils_Query::getStudentsByGrade( true, false, true , '' );
             ...
             if( $this->_object == 'fee' ) { 
                 ...
                 $this->addRule( 'total_blocks', ts('Please enter valid Total Blocks'), 'money' );
             } else {
                 $classes  =  School_Utils_Query::getClasses();
