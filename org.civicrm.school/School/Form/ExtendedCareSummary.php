...
class School_Form_ExtendedCareSummary extends CRM_Core_Form {
  ...
  function buildQuickForm( ) {
    ...
    $students = array( '' => '- Select Student -' ) + School_Utils_Query::getStudentsByGrade( true, false );
  ...
  function postProcess( ) {
    ...
    if ( $showBalances ) {
      $showDetails = false;
      $summary =& School_Utils_ExtendedCare::balanceDetails( );
    } else {
      $summary =& School_Utils_ExtendedCare::signoutDetails( $startDate     ,
                $endDate       ,
                $includeMorning,
                $showDetails   ,
                $notSignedOut  ,
