...
class School_Form_Family_Diversity extends School_Form_Family {
    ...
    function setDefaultValues( ) 
    {
        ...
        $groupID  = CRM_Core_DAO::getFieldValue( 'CRM_Core_DAO_CustomGroup', School_Form_Family::RACE_ETHNICITY_TABLE, 'id', 'table_name' );
...
WHERE      g.table_name = '". School_Form_Family::RACE_ETHNICITY_TABLE ."'
...
";
        ...
        $this->addFormRule( array( 'School_Form_Family_Diversity', 'formRule' ) ); 
    }
