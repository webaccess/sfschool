...
class School_Form_SignOut extends CRM_Core_Form {
    protected $_students;
...
";
    ...
    function postProcess( ) {
        ...
        for ( $i = 1 ; $i <= 6; $i++ ) {
            ...
            if ( ! empty( $studentID ) ) {
                School_Utils_ExtendedCare::processSignOut( $pickup,
                                                        $studentID,
                                                        $atSchoolMeeting );
            }
        }
    ...
    static function addSignOutRecord( ) {
        ...
        for ( $i = 1; $i <= 6; $i++ ) {
            ...
            $atSchoolMeeting = CRM_Utils_Request::retrieve( "atSchoolMeeting_$i",
                                                            ...
                                                            'REQUEST' );
            if ( ! empty( $studentID ) ) {
                $className = School_Utils_ExtendedCare::processSignOut( $pickup,
                                                                     $studentID,
                                                                     $atSchoolMeeting );
                if ( empty( $className ) ) {
                    $className = 'Yard Play';
