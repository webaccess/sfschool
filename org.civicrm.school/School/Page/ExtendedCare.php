...
class School_Page_ExtendedCare extends CRM_Core_Page {
  ...
  function edit( $id, $startDate, $endDate ) {
    ...
    $controller =& new CRM_Core_Controller_Simple( 'School_Form_ExtendedCare' ,'Edit Activity block');
    $controller->process( );
    $controller->run( );
  }
  ...
  function view( $id, $startDate, $endDate, $actionPermission , $calledByBrowse = false ) {
    ...
    if( $calledByBrowse ) {
      ...
      $details = School_Utils_ExtendedCare::signoutDetails( $startDate, $endDate, true, true, false, $id, 10 );
    } else {
      ...
      $details = School_Utils_ExtendedCare::signoutDetails( $detailStartDate,
                 $detailEndDate,
                 true,
                 true,
                 false,
  ...
  function browse( $id, $startDate, $endDate, $actionPermission ) {
    ...
    $details = School_Utils_ExtendedCareFees::feeDetails( $startDate,
               $endDateNew,
               null,
               false,
               true,
    ...
    $monthlySignout = School_Utils_ExtendedCare::signoutDetailsPerMonth( $startDate, $endDate, $id );
    ...
    $balanceDetails = School_Utils_ExtendedCare::balanceDetails( $id, $startDate, $endDate );
