...
class School_Report_Form_Econsent extends CRM_Report_Form {
    ...
    function from( ) {
        ...
        INNER JOIN  {$this->_customTable_schoolInfo} {$schoolInfoAlias} ON ({$this->_aliases['civicrm_contact']}.id = {$schoolInfoAlias}.entity_id AND {$this->_aliases['civicrm_contact']}.contact_sub_type like '%Student%' )
