...
class School_Report_Form_ParentTeacherConference extends CRM_Report_Form {
...
AND   (contact.contact_sub_type like '%Staff%' OR contact.contact_sub_type  like '%Parent%')
";
    $dao  = CRM_Core_DAO::executeQuery( $query );
