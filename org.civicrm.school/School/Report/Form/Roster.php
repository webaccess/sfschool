...
class School_Report_Form_Roster extends CRM_Report_Form {
...
";
 ...
 ";
  ...
  function where( ) {
    ...
    $this->_where = $this->_where ." AND r1.relationship_type_id = 1 AND r2.relationship_type_id = 1 AND ( {$this->_aliases['civicrm_contact_parent1']}.id < {$this->_aliases['civicrm_contact_parent2']}.id OR {$this->_aliases['civicrm_contact_parent2']}.id IS NULL ) AND  {$this->_aliases['civicrm_contact']}.contact_sub_type like '%Student%'";
