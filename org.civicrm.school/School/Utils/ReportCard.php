...
class School_Utils_ReportCard {
    ...
    static function getValues( $childrenIDs, &$values, $schoolYear = '2011-2012' ) {
        ...
        $reportCard = CRM_Core_DAO::getFieldValue( 'CRM_Core_DAO_CustomField', 'Report PDF', 'column_name', 'label' );

        $query = "
SELECT     c.id as contact_id,
           r.".$reportCard." as report_id,
...
ORDER BY  r.report_grade, r.report_term DESC
";
