...
global $civicrm_root;
if ( file_exists( '/home/lobo/svn/crm_42/civicrm.config.php' ) ) {
  $civicrm_root = '/home/lobo/svn/crm_42/';
  define('CIVICRM_CONFDIR', '/home/lobo/www/d7/sites/school');
...
function School_bin_Utils_auth( $auth = true ) {
  global $civicrm_root;
