...
LOAD DATA INFILE '/var/log/mysql/Spring2014.csv' INTO TABLE `school_extended_care_source`
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' ;
...
LOAD DATA INFILE '/home/sfschool/www/drupal/sites/all/modules/extensions/org.civicrm.school/sql/carryOver2013.csv' INTO
TABLE civicrm_value_extended_care_fee_tracker FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n' ;
...
UPDATE school_extended_care_source SET name = '5th Grade Girls Basketball' WHERE name = '5th Grade Girls Basketball 3:30 - 5:00 pm';
...
UPDATE school_extended_care_source SET name = 'Middle School Basketball' WHERE name = 'Basketball Team 3:30-5:00 p.m.';
...
INNER JOIN school_extended_care_source e ON ( s.name = e.name AND s.day_of_week = e.day_of_week AND e.term = 'Fall 2011' AND s.session = e.session )
