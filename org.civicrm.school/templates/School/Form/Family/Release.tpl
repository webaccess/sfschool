{crmDBTpl context='school family config' name='releases tab info' var='tabInfo'}
<div id="help">
{if !empty($tabInfo) }
 {$tabInfo}
{else}
...
{crmDBTpl context='school family config' name='release tab risk text' var='riskInfo'}
{ if !empty($riskInfo) }
  {$riskInfo}
{else}
<p>
...
{crmDBTpl context='school family config' name='release tab handbook text' var='handbookInfo'}
<p>
{ if !empty($handbookInfo) }
  {$handbookInfo}
{else}
I/we acknowledge that I/we have read <a href="http://sfschool.org/drupal/sites/default/files/families/publications/sfs-family-handbook-2012-13.pdf">The San Francisco School Parent Handbook </a> and agree to abide by the policies therein. I/we understand that The San Francisco School reserves the right to amend its policies and Handbook from time to time and I/we hereby agree to abide by such amended policies. The latest version of the Handbook can be downloaded <a href="http://sfschool.org/drupal/sites/default/files/families/publications/sfs-family-handbook-2012-13.pdf">here</a> and will be posted on The San Francisco School website.
{/if}
<table class="form-layout-compressed">
  <tr>
    <td>
...
{crmDBTpl context='school family config' name='release tab media text' var='mediaInfo'}
<p>
{ if !empty($mediaInfo) }
  {$mediaInfo}
{else}
...
{crmDBTpl context='school family config' name='release tab middle school text' var='middleInfo'}
